...
//  StockViewer
//
//  Created by Jim Long on 2/16/21.
//
...
struct SegmentedPicker: View {
    ...
    private static let BackgroundColor: Color = Color.themeAccent.opacity(0.2)
...
struct SegmentedPicker_Previews: PreviewProvider {
    static var previews: some View {
        SegmentedPicker(items: ["Deposit", "Withdrawal"], selection: .constant(0))
            .padding()
    }
}
